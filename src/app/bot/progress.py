...
PROGRESS_BY_STEP: dict[Step, ProgressSpec] = {
    ...
    Step.REVIEW_SALES_SUMMARY: ProgressSpec(2, 5, "PROGRESS_PHASE_SALES"),
    Step.EDIT_SALES_MENU: ProgressSpec(2, 5, "PROGRESS_PHASE_SALES"),
    Step.ASK_STOCK_ISSUE: ProgressSpec(3, 5, "PROGRESS_PHASE_STOCK_ISSUE"),
    Step.ASK_NOTE: ProgressSpec(4, 5, "PROGRESS_PHASE_NOTE"),
